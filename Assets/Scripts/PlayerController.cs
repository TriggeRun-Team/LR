...
public class PlayerController : MonoBehaviour
{
    ...
    void CheckInput()
    {
        ...
        else
        {
            ...
            #region Christ Air
            if ((Input.GetKey(KeyCode.V) || RefManager.I.gameplayMenu.isCAPressed) && midAirTrickSettings.isMidair)
            {
    ...
    void StopChristAir()
    {
        if (Input.GetKey(KeyCode.V) || RefManager.I.gameplayMenu.isCAPressed || anim.GetInteger("Trick") == 0)
            return;
